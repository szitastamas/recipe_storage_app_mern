                        ...
                        return (
                            <li key={recipe._id} className='collection-item'>
                                <div className='row'>
                                    ...
                                    <div className={`col s3 ${secondaryTextColor}`} style={{ textTransform: 'capitalize' }}>
                                        {recipe.type}
                                    </div>
                                    <div className={`col s3 right`}>
                                        <Link to='#' className='secondary-content btn small red' onClick={() => deleteRecipe(recipe._id)}>
                                            <i className='material-icons'>delete</i>
                                        </Link>
                                        <Link to='#' className='secondary-content btn blue lighten-2' onClick={() => handleEdit(recipe)}>
