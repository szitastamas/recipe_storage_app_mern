    ...
    <div className="col s12 l6">
      ...
      {loading ? (
        ...
        <ul className="collection">
          <div className="collection-item" key={"dashboard-list-header"}>
            <div className="row">
              ...
              <div className="col s3" style={{ fontWeight: "600" }}>
                Type
              </div>
        ...
        <p className="center" style={{ padding: "2rem" }}>
          Your Recipe Storage is empty. Upload some of your favourite recipes
          today!
        </p>
      )}
      {recipeDetails && (
        <RecipeDetails recipe={recipeDetails} removeDetails={removeDetails} />
      )}
    </div>
  );
};
