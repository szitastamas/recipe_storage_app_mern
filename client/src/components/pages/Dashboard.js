...
const Dashboard = props => {
  ...
  return (
    <div className="col s12 l6">
      ...
      { (recipes.length > 0) ? <Recipes customGrid="dashboard-recipe-grid" location="dashboard" />
      : <p className="center" style={{padding: "2rem"}}>Your Recipe Storage is empty. Upload some of your favourite recipes today!</p> }
