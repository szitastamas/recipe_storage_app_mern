      ...
      <form id="add-form center" onSubmit={handleSubmit}>
        ...
        <div className="row">
          <div className="col s6">
            ...
            <select
              ...
              value={recipe.type}
              onChange={handleChange}
              className={`${uiColor} ${secondaryTextColor}`}
            >
        ...
        <div className="file-field input-field">
          ...
          <div className="file-path-wrapper">
            <input
              type="text"
              className={`file-path validate ${uiColor} ${secondaryTextColor}`}
        ...
        {!editState ? (
          <button
            type="submit"
            className="btn submit-btn waves-effect waves-light"
          >
            Add Recipe
          </button>
        ) : (
          <Fragment>
            <button
              type="submit"
              className="btn submit-btn green lighten-1 waves-effect waves-light"
            >
              Update Recipe
            </button>
            <button
              onClick={handleCancel}
              className="btn submit-btn orange lighten-3 waves-effect waves-light"
            >
              Cancel
            </button>
          </Fragment>
